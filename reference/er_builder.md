...
This page documents the shared interface all `er_builder_*()` builders
...
differently from any of the built-in `builder` options – e.g. a 2D
density instead of a scatter for the data overlay, per-panel histograms
