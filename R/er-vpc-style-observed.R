...
#' quantile-bin) bin label, or as a continuous-x line of empirical
#' percentiles.
#'
...
#'   error bars, and of `er_style_vpc_observed_mean_errorbar()`'s when
...
#' also available (continuous/count response, numeric `plot_by`), it
