...
#'   Defaults to `1.5` for `er_style_vpc_simulated_quantile_errorbar()`,
#'   or `2` for `er_style_vpc_simulated_mean_errorbar()`.
...
#' it carries no `vpc_layout` tag -- pair it with
...
#' @seealso [er_style_vpc()], [er_style_vpc_observed()]
NULL
