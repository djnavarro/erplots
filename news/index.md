...
- Every layer-adding function
  ...
  and all five `er_tte_add_*()` functions) now documents a “Styles”
  table listing every registered `style` label for that layer, linking
  straight to each builder’s own help page.
