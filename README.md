...
(e.g. [erlr](https://github.com/djnavarro/erlr) for logistic
...
#>     <dbl> <dbl> <fct>   <int>  <int>
#>  1 0.358   673. Male        1      1
#>  2 0.991  2806. Female      2      1
#>  3 0.0803    0  Female      3      1
#>  4 0.627  1169. Female      4      1
#>  5 0.209   377. Male        5      1
#>  6 0.166   327. Female      6      1
#>  7 0.0923    0  Male        7      1
#>  8 0.649  1208. Female      8      1
#>  9 0.0923    0  Male        9      1
#> 10 0.142   254. Female     10      1
#> # ℹ 29,990 more rows
