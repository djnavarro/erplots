...
belongs to via [er_layout()], which is what `er_plot_show_data()` uses
...
for `build_data_boxjitter()`, sharing the model curve's own legend, the
same way `build_data_overlay()`'s color aesthetic does for any response
type:
