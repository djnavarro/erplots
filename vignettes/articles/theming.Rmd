---
title: "Theming exposure-response plots"
---
...
(e.g. from `ggplot2::scale_colour_brewer()` or
`ggplot2::scale_colour_viridis_d()`) and apply it wherever `colour`/`fill`
...
the one built-in example (a continuous/count response's response-coloured
...
* [The exposure-response plotting grammar](design.html) explains the layer-composition
