...
with erlr, but the plotting code itself has no knowledge of `glm()`.
...
```{r stratification-1}
mod_strat <- lr_model(ae1 ~ aucss + sex, lr_data)
...
implement `er_simulate()` (erlr's models do); models that only implement
