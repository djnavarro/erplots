...
*structural* family (declared via [er_builder_tag()]) that builder belongs
to:
...
public part of the API (see [er_builder()]), each layer's `builder`
...
*structural* family it belongs to via [er_builder_tag()].
