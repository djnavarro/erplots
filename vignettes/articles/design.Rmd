...
builder in detail, see [Extending erplots](extending.html).

<!-- agent-note: if a design choice described here ever changes, update
this article in the same change -- see the note at the end. -->
