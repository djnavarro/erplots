...
exposure variable (maximum drug concentration, AUC, and so on). The usual
...
See [Theming erplots](theming.html) for every argument
...
* [Theming erplots](theming.html) covers every `er_plot_theme()`
...
* [Model interface](model-interface.html) describes the technicalities.
  It outlines what erplots needs from other packages in order to be
  able to use its models when drawing exposure-response plots.
